use forti_client::tun::routes::{route_add_cmd, route_delete_cmd, mask_to_prefix};
use forti_client::auth::xml::Route;
use std::net::Ipv4Addr;

#[test]
fn test_route_add_subnet() {
    let route = Route { ip: Ipv4Addr::new(10, 60, 0, 0), mask: Ipv4Addr::new(255, 255, 240, 0) };
...
fn test_route_add_host() {
    let route = Route { ip: Ipv4Addr::new(18, 169, 33, 210), mask: Ipv4Addr::new(255, 255, 255, 255) };
    let args = route_add_cmd(&route, "utun3");
